 ...
 * @fn: Associated function pointer.
 */
	struct fmt
{
	char fmt;
 ...
 * @fmt: The format string.
 * @fm_t: Associated function pointer.
 */
	...
	/* functions for printing non printable characters */
	...
	/*For printing a string in rot 13*/
